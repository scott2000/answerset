...
def test_parse_several_numbers_with_factor():
...
def test_number_missing_with_factor():
...
def test_number_wrong_with_factor():
    correct = 'the answer is 12?0.9'
...
def test_number_close_with_factor():
...
def test_number_exact_with_factor():
    correct = 'the answer is 12?1.0'
    given = 'the answer is 12.0'
    result = compare_answer_no_html(factor(1.1), correct, given)
    assert result == '<div id=typeans><code><span class=typeGood>the answer is 12</span></code></div>'

def test_number_string_comparison():
    correct = 'the answer is 12'
    given = 'the answer is 12.0'
...
def test_number_string_comparison_with_factor():
